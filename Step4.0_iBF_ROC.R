# This R script prepares data to create ROC curves for iBF outcomes.
####################################
...
iBF_lists_0.2null_regrouped <- readRDS("iBF_lists_0.2null_regrouped.RDS")
...
saveRDS(iBF_TPFP4ROC_0.2null, "iBF_0.2null.RDS")
