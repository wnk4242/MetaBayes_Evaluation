...
current_rep_results <- readRDS(sprintf("%s/hihi_rep_results_part%d.RDS", folder_path, segment_index))
current_IDs <- readRDS(sprintf("%s/hihi_IDs_part%d.RDS", folder_path, segment_index))
...
# Save result
saveRDS(iBF_lists_hihi,
        sprintf("./RDS/MABFoutcomes/500500/iBF/hihi/iBF_lists_hihi_part%d.RDS", segment_index))
