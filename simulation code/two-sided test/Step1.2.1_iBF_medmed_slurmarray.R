...
current_rep_results <- readRDS(sprintf("%s/medmed_rep_results_part%d.RDS", folder_path, segment_index))
current_IDs <- readRDS(sprintf("%s/medmed_IDs_part%d.RDS", folder_path, segment_index))
...
# Save result
saveRDS(iBF_lists_medmed,
        sprintf("./RDS/MABFoutcomes/500500/iBF/medmed/iBF_lists_medmed_part%d.RDS", segment_index))
