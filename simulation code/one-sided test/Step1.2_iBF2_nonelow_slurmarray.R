...
folder_path <- "./RDS/REP4EVAL/200500/nonelow_200500_9parts" #or nonelow_500500
...
# Save results
saveRDS(iBF_lists_nonelow, sprintf(".//RDS/MABFoutcomes/200500/iBF2/nonelow/iBF2_lists_nonelow_part%d.RDS", segment_index))
