...
iBF2_lists_0.2null_regrouped <- readRDS("./RDS/MABF4ROC/iBF2_lists_0.2null_regrouped.RDS")
...
iBF2_TPFP4ROC_0.2null <- data.frame()

# Set up parallel processing plan
plan(multisession, workers = parallel::detectCores())

# Apply ratesCalc_ROC and thresholds to every sublist of MABF values
list_of_sublists <- iBF2_lists_0.2null_regrouped

# Process all sublists in parallel
iBF2_TPFP4ROC_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
iBF2_TPFP4ROC_0.2null <- iBF2_TPFP4ROC_0.2null %>% 
...
saveRDS(iBF2_TPFP4ROC_0.2null, "./RDS/rates4ROC/iBF2_TPFP4ROC_0.2null.RDS")
