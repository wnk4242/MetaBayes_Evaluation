...
BFbMA_lists_0.5null_regrouped <- readRDS("./RDS/MABF4ROC/BFbMA_lists_0.5null_regrouped.RDS")
...
BFbMA_TPFP4ROC_0.5null <- data.frame()

# Set up parallel processing plan
plan(multisession, workers = parallel::detectCores())

# Apply ratesCalc_ROC and thresholds to every sublist of MABF values
list_of_sublists <- BFbMA_lists_0.5null_regrouped

# Process all sublists in parallel
BFbMA_TPFP4ROC_0.5null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
BFbMA_TPFP4ROC_0.5null <- BFbMA_TPFP4ROC_0.5null %>% 
...
saveRDS(BFbMA_TPFP4ROC_0.5null, "./RDS/rates4ROC/BFbMA_TPFP4ROC_0.5null.RDS")
