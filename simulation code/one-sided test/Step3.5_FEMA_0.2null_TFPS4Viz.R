...
# FEMA_TFPS4Viz_0.2null <- data.frame()
# 
...
# FEMA_TFPS4Viz_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
# saveRDS(FEMA_TFPS4Viz_0.2null, "./RDS/MABFanalyses/matrix-wise/rates4Viz/FEMA_TFPS4Viz_0.2null.RDS")
...
## 4. Read input data
## =========================
FEMA_lists_0.2null_regrouped_deltap <- readRDS(
  "./MABF4ROC/4TSFS/FEMA_lists_0.2null_regrouped_deltap.RDS"
)
...
## =========================
FEMA_TFPS4Viz_0.2null <- dplyr::bind_rows(results_list)
...
saveRDS(
  ...
  "./MABFanalyses/matrix-wise/rates4Viz/FEMA_TFPS4Viz_0.2null.RDS"
)
