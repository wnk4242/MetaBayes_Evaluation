...
###################################
# Set the path to the directory containing RDS files
folder_path <- "./MABFoutcomes/500500/iBF2" 
# List all RDS files in the directory
rds_files <- list.files(folder_path, pattern = "\\.RDS$", full.names = TRUE)
# Read in all RDS files into the workspace
for (file_path in rds_files) {
...
iBF2_lists <- c(iBF2_lists_nonelow_part1,iBF2_lists_nonelow_part2,iBF2_lists_nonelow_part3,
                  iBF2_lists_nonelow_part4,iBF2_lists_nonelow_part5,iBF2_lists_nonelow_part6,
                  iBF2_lists_nonelow_part7,iBF2_lists_nonelow_part8,iBF2_lists_nonelow_part9,
                  iBF2_lists_medmed_part1,iBF2_lists_medmed_part2,iBF2_lists_medmed_part3,
                  iBF2_lists_medmed_part4,iBF2_lists_medmed_part5,iBF2_lists_medmed_part6,
                  iBF2_lists_medmed_part7,iBF2_lists_medmed_part8,iBF2_lists_medmed_part9,
                  iBF2_lists_hihi_part1,iBF2_lists_hihi_part2,iBF2_lists_hihi_part3,
                  iBF2_lists_hihi_part4,iBF2_lists_hihi_part5,iBF2_lists_hihi_part6,
                  iBF2_lists_hihi_part7,iBF2_lists_hihi_part8,iBF2_lists_hihi_part9)
# Remove wont-be-used lists
remove(iBF2_lists_nonelow_part1,iBF2_lists_nonelow_part2,iBF2_lists_nonelow_part3,
       iBF2_lists_nonelow_part4,iBF2_lists_nonelow_part5,iBF2_lists_nonelow_part6,
       iBF2_lists_nonelow_part7,iBF2_lists_nonelow_part8,iBF2_lists_nonelow_part9,
       iBF2_lists_medmed_part1,iBF2_lists_medmed_part2,iBF2_lists_medmed_part3,
       iBF2_lists_medmed_part4,iBF2_lists_medmed_part5,iBF2_lists_medmed_part6,
...
name_witht_0.2 <- !startsWith(names(iBF2_lists), "0.2")
iBF2_lists_0.5null <- iBF2_lists[name_witht_0.2]
name_witht_0.5 <- !startsWith(names(iBF2_lists), "0.5")
iBF2_lists_0.2null <- iBF2_lists[name_witht_0.5]
remove(iBF2_lists)
...
# iBF2_lists_0.2null_regrouped combines sublists with delta of 0 and 0.2
iBF2_lists_0.2null_regrouped = list()
# Iterate through the list of sublists two at a time
for(i in seq(1, length(iBF2_lists_0.2null), by = 2)) {
  # Combine vectors from the current pair of sublists
  combined = combine_vectors(iBF2_lists_0.2null[[i]], iBF2_lists_0.2null[[i+1]], chunk_size=num_deltai)
  # Add the combined result to the final groups list
  iBF2_lists_0.2null_regrouped[[length(iBF2_lists_0.2null_regrouped) + 1]] = combined
}
# Naming iBF2 sublists and matricies within
# Naming the main sublists
names(iBF2_lists_0.2null_regrouped) <- IDs_MABFlists_002
# Naming contained matricies
iBF2_lists_0.2null_regrouped <- lapply(iBF2_lists_0.2null_regrouped, function(sublist) {
...
########################################################
# Initialize an empty list to store the final groups
# iBF2_lists_0.5null_regrouped combines sublists with delta of 0 and 0.5
iBF2_lists_0.5null_regrouped = list()
# Iterate through the list of sublists two at a time
for(i in seq(1, length(iBF2_lists_0.5null), by = 2)) {
  # Combine vectors from the current pair of sublists
  combined = combine_vectors(iBF2_lists_0.5null[[i]], iBF2_lists_0.5null[[i+1]], chunk_size=num_deltai)
  # Add the combined result to the final groups list
  iBF2_lists_0.5null_regrouped[[length(iBF2_lists_0.5null_regrouped) + 1]] = combined
}
# Naming iBF2 sublists and matricies within
# Naming the main sublists
names(iBF2_lists_0.5null_regrouped) <- IDs_MABFlists_005
# Naming contained matricies
iBF2_lists_0.5null_regrouped <- lapply(iBF2_lists_0.5null_regrouped, function(sublist) {
  names(sublist) <- IDs_MABFsubls
  return(sublist)
})
