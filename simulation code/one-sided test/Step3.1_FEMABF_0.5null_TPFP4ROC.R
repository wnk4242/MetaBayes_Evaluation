...
FEMABF_lists_0.5null_regrouped <- readRDS("./RDS/MABF4ROC/FEMABF_lists_0.5null_regrouped.RDS")
...
FEMABF_TPFP4ROC_0.5null <- data.frame()

# Set up parallel processing plan
plan(multisession, workers = parallel::detectCores())

# Apply ratesCalc_ROC and thresholds to every sublist of MABF values
list_of_sublists <- FEMABF_lists_0.5null_regrouped

# Process all sublists in parallel
FEMABF_TPFP4ROC_0.5null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
FEMABF_TPFP4ROC_0.5null <- FEMABF_TPFP4ROC_0.5null %>% 
...
saveRDS(FEMABF_TPFP4ROC_0.5null, "./RDS/rates4ROC/FEMABF_TPFP4ROC_0.5null.RDS")
