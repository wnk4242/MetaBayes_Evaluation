...
######################################
#MABF method: EUBF; dataset: 0.5null#
######################################
...
EUBF_lists_0.5null_regrouped_deltap <- readRDS("./RDS/MABF4ROC/4TSFS/EUBF_lists_0.5null_regrouped_deltap.RDS")
...
EUBF_TFPS4Viz_0.5null <- data.frame()
...
list_of_sublists <- EUBF_lists_0.5null_regrouped_deltap

# Process all sublists in parallel
EUBF_TFPS4Viz_0.5null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
EUBF_TFPS4Viz_0.5null <- EUBF_TFPS4Viz_0.5null %>% 
...
saveRDS(EUBF_TFPS4Viz_0.5null, "./RDS/MABFanalyses/matrix-wise/rates4Viz/EUBF_TFPS4Viz_0.5null.RDS")
