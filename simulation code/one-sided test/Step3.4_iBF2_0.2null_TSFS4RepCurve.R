...
iBF2_TSFS4RepCurve_0.2null <- data.frame()
...
iBF2_TSFS4RepCurve_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
iBF2_TSFS4RepCurve_0.2null <- iBF2_TSFS4RepCurve_0.2null %>% 
...
saveRDS(iBF2_TSFS4RepCurve_0.2null, "./RDS/rates4RepCurve/iBF2_TSFS4RepCurve_0.2null.RDS")
