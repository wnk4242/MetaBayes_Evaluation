...
#   output$downloadPlot <- downloadHandler(
#     filename = function() {
#       paste0("ROC_ES", input$es_choice, "_3x3_1sided.png")
#     },
#     content = function(file) {
...
#####
# # This version displays complete ROC curves in all scenarios together in a 3x3 grid
# # === Packages ===
# library(shiny)
# library(ggplot2)
# library(dplyr)
...
#           plot.title = element_text(size = 11, face = "bold", hjust = 0.5),
#           legend.position = "none",
#           axis.text.x = if (row_id == 3) element_text() else element_blank(),
#           axis.ticks.x = if (row_id == 3) element_line() else element_blank(),
#           axis.text.y = if (col_id == 1) element_text() else element_blank(),
