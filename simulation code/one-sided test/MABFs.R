...
#######################################
# BFroMeta() functions are uncorrected. Corrected are BFroMeta_1sided/2sided in ColabSim folder
...
# simMA is in QRP and PB function.R
# df <- simMA(20,0.5,0.03,"none","low",fixed.n = 20) #simMA is in QRP and PB functions.R
