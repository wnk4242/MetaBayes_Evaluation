...
#saveRDS(EUBF_lists_0.2null_regrouped_deltap, file = "./MABF4ROC/4TSFS/EUBF_lists_0.2null_regrouped_deltap.RDS")
#saveRDS(EUBF_lists_0.5null_regrouped_deltap, file = "./MABF4ROC/4TSFS/EUBF_lists_0.5null_regrouped_deltap.RDS")
...
#       EUBF_lists_0.2null_regrouped_deltap[[outerlist_index]] <- list()
#       for (innermatrix_index in 1:num_innermatrixs) {
#         matrix_BFs_deltap <- cbind(rep(c(0,0.2), each = num_deltai), orig_p_matrix_0.2null[, outerlist_index], obs_d_matrix_0.2null[, outerlist_index], EUBF_lists_0.2null_regrouped[[outerlist_index]][[innermatrix_index]])
#         EUBF_lists_0.2null_regrouped_deltap[[outerlist_index]][[innermatrix_index]] <- matrix_BFs_deltap
#       }
#     }
#     
#     EUBF_lists_0.2null_regrouped_deltap <- as.list(EUBF_lists_0.2null_regrouped_deltap)
...
#     for (outerlist_index in 1:num_outerlists) {
#       for (innermatrix_index in 1:num_innermatrixs) {
#         colnames(EUBF_lists_0.2null_regrouped_deltap[[outerlist_index]][[innermatrix_index]]) <- c("delta","original_p","observed_es",1:rep_times)
#       }
#     }
#     
#     EUBF_TFSFrates_0.2null <- do.call(rbind, lapply(EUBF_lists_0.2null_regrouped_deltap, function(sublist) {
...
#     
#     for (outerlist_index in 1:num_outerlists) {
#       EUBF_lists_0.5null_regrouped_deltap[[outerlist_index]] <- list()
#       for (innermatrix_index in 1:num_innermatrixs) {
#         matrix_BFs_deltap <- cbind(rep(c(0,0.5), each = num_deltai), orig_p_matrix_0.5null[, outerlist_index], obs_d_matrix_0.5null[, outerlist_index], EUBF_lists_0.5null_regrouped[[outerlist_index]][[innermatrix_index]])
#         EUBF_lists_0.5null_regrouped_deltap[[outerlist_index]][[innermatrix_index]] <- matrix_BFs_deltap
#       }
#     }
#     
#     EUBF_lists_0.5null_regrouped_deltap <- as.list(EUBF_lists_0.5null_regrouped_deltap)
...
#     for (outerlist_index in 1:num_outerlists) {
#       for (innermatrix_index in 1:num_innermatrixs) {
#         colnames(EUBF_lists_0.5null_regrouped_deltap[[outerlist_index]][[innermatrix_index]]) <- c("delta","original_p", "observed_es", 1:rep_times)
#       }
#     }
#     
#     EUBF_TFSFrates_0.5null <- do.call(rbind, lapply(EUBF_lists_0.5null_regrouped_deltap, function(sublist) {
...
#     
#     # Step 3: Save analysis outcomes
#     saveRDS(rates_EUBF_0.2null, paste0("./MABFanalyses/matrix-wise/rates4Plot/fixed original cutoff/", directory, folder, "/rates_EUBF_0.2null_", folder, ".RDS"))
#     saveRDS(rates_EUBF_0.5null, paste0("./MABFanalyses/matrix-wise/rates4Plot/fixed original cutoff/", directory, folder, "/rates_EUBF_0.5null_", folder, ".RDS"))
#   }
