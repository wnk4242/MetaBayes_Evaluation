...
######################################
#MABF method: iBF2; dataset: 0.2null#
######################################
...
iBF2_lists_0.2null_regrouped_deltap <- readRDS("./RDS/MABF4ROC/4TSFS/iBF2_lists_0.2null_regrouped_deltap.RDS")
...
iBF2_TFPS4Viz_0.2null <- data.frame()
...
list_of_sublists <- iBF2_lists_0.2null_regrouped_deltap

# Process all sublists in parallel
iBF2_TFPS4Viz_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
iBF2_TFPS4Viz_0.2null <- iBF2_TFPS4Viz_0.2null %>% 
...
saveRDS(iBF2_TFPS4Viz_0.2null, "./RDS/MABFanalyses/matrix-wise/rates4Viz/iBF2_TFPS4Viz_0.2null.RDS")
