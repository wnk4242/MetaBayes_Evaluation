...
for (dir_index in 1:total_directories) {
  ...
  for (criteria in updated_criteria_list) {
    ...
    saveRDS(rates_EUBF_0.2null, paste0("./MABFanalyses/matrix-wise/rates4Plot/", directory, folder, "/rates_EUBF_0.2null_", folder, ".RDS"))
    saveRDS(rates_EUBF_0.5null, paste0("./MABFanalyses/matrix-wise/rates4Plot/", directory, folder, "/rates_EUBF_0.5null_", folder, ".RDS"))
  }
