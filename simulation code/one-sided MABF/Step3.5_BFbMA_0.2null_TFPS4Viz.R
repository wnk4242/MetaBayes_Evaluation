...
BFbMA_TFPS4Viz_0.2null <- data.frame()
...
BFbMA_TFPS4Viz_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
BFbMA_TFPS4Viz_0.2null <- BFbMA_TFPS4Viz_0.2null %>% 
...
saveRDS(BFbMA_TFPS4Viz_0.2null, "./RDS/MABFanalyses/matrix-wise/rates4Viz/BFbMA_TFPS4Viz_0.2null.RDS")
