...
BFbMA_lists_0.2null_regrouped_deltap <- readRDS("./RDS/MABF4ROC/4TSFS/BFbMA_lists_0.2null_regrouped_deltap.RDS")
...
BFbMA_TSFS4RepCurve_0.2null <- data.frame()
...
list_of_sublists <- BFbMA_lists_0.2null_regrouped_deltap

# Process all sublists in parallel
BFbMA_TSFS4RepCurve_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
BFbMA_TSFS4RepCurve_0.2null <- BFbMA_TSFS4RepCurve_0.2null %>% 
...
saveRDS(BFbMA_TSFS4RepCurve_0.2null, "./RDS/rates4RepCurve/BFbMA_TSFS4RepCurve_0.2null.RDS")
