...
###################################
# Set the path to the directory containing RDS files
folder_path <- "./MABFoutcomes/500500/BFbMA" 
# List all RDS files in the directory
rds_files <- list.files(folder_path, pattern = "\\.RDS$", full.names = TRUE)
# Read in all RDS files into the workspace
for (file_path in rds_files) {
...
BFbMA_lists <- c(BFbMA_lists_nonelow_part1,BFbMA_lists_nonelow_part2,BFbMA_lists_nonelow_part3,
                  BFbMA_lists_nonelow_part4,BFbMA_lists_nonelow_part5,BFbMA_lists_nonelow_part6,
                  BFbMA_lists_nonelow_part7,BFbMA_lists_nonelow_part8,BFbMA_lists_nonelow_part9,
                  BFbMA_lists_medmed_part1,BFbMA_lists_medmed_part2,BFbMA_lists_medmed_part3,
                  BFbMA_lists_medmed_part4,BFbMA_lists_medmed_part5,BFbMA_lists_medmed_part6,
                  BFbMA_lists_medmed_part7,BFbMA_lists_medmed_part8,BFbMA_lists_medmed_part9,
                  BFbMA_lists_hihi_part1,BFbMA_lists_hihi_part2,BFbMA_lists_hihi_part3,
                  BFbMA_lists_hihi_part4,BFbMA_lists_hihi_part5,BFbMA_lists_hihi_part6,
                  BFbMA_lists_hihi_part7,BFbMA_lists_hihi_part8,BFbMA_lists_hihi_part9)
# Remove wont-be-used lists
remove(BFbMA_lists_nonelow_part1,BFbMA_lists_nonelow_part2,BFbMA_lists_nonelow_part3,
       BFbMA_lists_nonelow_part4,BFbMA_lists_nonelow_part5,BFbMA_lists_nonelow_part6,
       BFbMA_lists_nonelow_part7,BFbMA_lists_nonelow_part8,BFbMA_lists_nonelow_part9,
       BFbMA_lists_medmed_part1,BFbMA_lists_medmed_part2,BFbMA_lists_medmed_part3,
       BFbMA_lists_medmed_part4,BFbMA_lists_medmed_part5,BFbMA_lists_medmed_part6,
...
name_witht_0.2 <- !startsWith(names(BFbMA_lists), "0.2")
BFbMA_lists_0.5null <- BFbMA_lists[name_witht_0.2]
name_witht_0.5 <- !startsWith(names(BFbMA_lists), "0.5")
BFbMA_lists_0.2null <- BFbMA_lists[name_witht_0.5]
remove(BFbMA_lists)
...
# BFbMA_lists_0.2null_regrouped combines sublists with delta of 0 and 0.2
BFbMA_lists_0.2null_regrouped = list()
# Iterate through the list of sublists two at a time
for(i in seq(1, length(BFbMA_lists_0.2null), by = 2)) {
  # Combine vectors from the current pair of sublists
  combined = combine_vectors(BFbMA_lists_0.2null[[i]], BFbMA_lists_0.2null[[i+1]], chunk_size=num_deltai)
  # Add the combined result to the final groups list
  BFbMA_lists_0.2null_regrouped[[length(BFbMA_lists_0.2null_regrouped) + 1]] = combined
}
# Naming BFbMA sublists and matricies within
# Naming the main sublists
names(BFbMA_lists_0.2null_regrouped) <- IDs_MABFlists_002
# Naming contained matricies
BFbMA_lists_0.2null_regrouped <- lapply(BFbMA_lists_0.2null_regrouped, function(sublist) {
...
########################################################
# Initialize an empty list to store the final groups
# BFbMA_lists_0.5null_regrouped combines sublists with delta of 0 and 0.5
BFbMA_lists_0.5null_regrouped = list()
# Iterate through the list of sublists two at a time
for(i in seq(1, length(BFbMA_lists_0.5null), by = 2)) {
  # Combine vectors from the current pair of sublists
  combined = combine_vectors(BFbMA_lists_0.5null[[i]], BFbMA_lists_0.5null[[i+1]], chunk_size=num_deltai)
  # Add the combined result to the final groups list
  BFbMA_lists_0.5null_regrouped[[length(BFbMA_lists_0.5null_regrouped) + 1]] = combined
}
# Naming BFbMA sublists and matricies within
# Naming the main sublists
names(BFbMA_lists_0.5null_regrouped) <- IDs_MABFlists_005
# Naming contained matricies
BFbMA_lists_0.5null_regrouped <- lapply(BFbMA_lists_0.5null_regrouped, function(sublist) {
  names(sublist) <- IDs_MABFsubls
  return(sublist)
})


#saveRDS(BFbMA_lists_0.2null_regrouped, file = "./MABF4ROC/4TPFP/BFbMA_lists_0.2null_regrouped.RDS")
#saveRDS(BFbMA_lists_0.5null_regrouped, file = "./MABF4ROC/4TPFP/BFbMA_lists_0.5null_regrouped.RDS")
