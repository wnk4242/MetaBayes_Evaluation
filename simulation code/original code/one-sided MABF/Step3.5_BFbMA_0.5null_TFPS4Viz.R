...
######################################
#MABF method: BFbMA; dataset: 0.5null#
######################################
...
BFbMA_lists_0.5null_regrouped_deltap <- readRDS("./RDS/MABF4ROC/4TSFS/BFbMA_lists_0.5null_regrouped_deltap.RDS")
...
BFbMA_TFPS4Viz_0.5null <- data.frame()
...
list_of_sublists <- BFbMA_lists_0.5null_regrouped_deltap

# Process all sublists in parallel
BFbMA_TFPS4Viz_0.5null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
BFbMA_TFPS4Viz_0.5null <- BFbMA_TFPS4Viz_0.5null %>% 
...
saveRDS(BFbMA_TFPS4Viz_0.5null, "./RDS/MABFanalyses/matrix-wise/rates4Viz/BFbMA_TFPS4Viz_0.5null.RDS")
