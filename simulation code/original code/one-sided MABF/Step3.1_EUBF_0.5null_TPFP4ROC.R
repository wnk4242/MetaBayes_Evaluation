...
EUBF_lists_0.5null_regrouped <- readRDS("./RDS/MABF4ROC/EUBF_lists_0.5null_regrouped.RDS")
...
EUBF_TPFP4ROC_0.5null <- data.frame()

# Set up parallel processing plan
plan(multisession, workers = parallel::detectCores())

# Apply ratesCalc_ROC and thresholds to every sublist of MABF values
list_of_sublists <- EUBF_lists_0.5null_regrouped

# Process all sublists in parallel
EUBF_TPFP4ROC_0.5null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
EUBF_TPFP4ROC_0.5null <- EUBF_TPFP4ROC_0.5null %>% 
...
saveRDS(EUBF_TPFP4ROC_0.5null, "./RDS/rates4ROC/EUBF_TPFP4ROC_0.5null.RDS")
