...
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
#Inclusion Bayes Factor of Bayesian Averaged Meta-Analysis (hihi)#
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++#
######################################################
...
for(j in seq_along(current_rep_results)) {
  ...
  iBF_lists_hihi [[j]] <- iBF_list  # Store the temporary list in the main list
  names(iBF_lists_hihi [[j]]) <- current_IDs[[j]]
}
# Reset to sequential plan
plan(sequential)
names(iBF_lists_hihi) <- names(current_IDs)
# Save results
saveRDS(iBF_lists_hihi, sprintf(".//RDS/MABFoutcomes/500500/iBF/hihi/iBF_lists_hihi_part%d.RDS", segment_index))
