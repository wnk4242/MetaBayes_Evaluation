...
iBF_lists_0.2null_regrouped_deltap <- readRDS("./RDS/MABF4ROC/4TSFS/iBF_lists_0.2null_regrouped_deltap.RDS")
...
iBF_TSFS4RepCurve_0.2null <- data.frame()
...
list_of_sublists <- iBF_lists_0.2null_regrouped_deltap

# Process all sublists in parallel
iBF_TSFS4RepCurve_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
iBF_TSFS4RepCurve_0.2null <- iBF_TSFS4RepCurve_0.2null %>% 
...
saveRDS(iBF_TSFS4RepCurve_0.2null, "./RDS/rates4RepCurve/iBF_TSFS4RepCurve_0.2null.RDS")
