...
FEMABF_TFPS4Viz_0.2null <- data.frame()
...
FEMABF_TFPS4Viz_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
FEMABF_TFPS4Viz_0.2null <- FEMABF_TFPS4Viz_0.2null %>% 
...
saveRDS(FEMABF_TFPS4Viz_0.2null, "./RDS/MABFanalyses/matrix-wise/rates4Viz/FEMABF_TFPS4Viz_0.2null.RDS")
