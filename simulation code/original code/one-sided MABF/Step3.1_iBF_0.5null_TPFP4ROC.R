...
iBF_lists_0.5null_regrouped <- readRDS("./RDS/MABF4ROC/iBF_lists_0.5null_regrouped.RDS")
...
iBF_TPFP4ROC_0.5null <- data.frame()

# Set up parallel processing plan
plan(multisession, workers = parallel::detectCores())

# Apply ratesCalc_ROC and thresholds to every sublist of MABF values
list_of_sublists <- iBF_lists_0.5null_regrouped

# Process all sublists in parallel
iBF_TPFP4ROC_0.5null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
iBF_TPFP4ROC_0.5null <- iBF_TPFP4ROC_0.5null %>% 
...
saveRDS(iBF_TPFP4ROC_0.5null, "./RDS/rates4ROC/iBF_TPFP4ROC_0.5null.RDS")
