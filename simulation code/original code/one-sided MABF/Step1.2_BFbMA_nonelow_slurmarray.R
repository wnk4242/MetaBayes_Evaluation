#++++++++++++++++++++++++++++++++++++++++++++++#
#Bayes Factor based on Meta-Analysis (nonelow) #
#++++++++++++++++++++++++++++++++++++++++++++++#
######################################################
...
# Save results
saveRDS(BFbMA_lists_nonelow, sprintf("./RDS/MABFoutcomes/500500/BFbMA/nonelow/BFbMA_lists_nonelow_part%d.RDS", segment_index))
