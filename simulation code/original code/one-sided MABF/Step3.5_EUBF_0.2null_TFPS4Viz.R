...
EUBF_TFPS4Viz_0.2null <- data.frame()
...
EUBF_TFPS4Viz_0.2null <- future_map_dfr(names(list_of_sublists), function(sublist_name) {
...
EUBF_TFPS4Viz_0.2null <- EUBF_TFPS4Viz_0.2null %>% 
...
saveRDS(EUBF_TFPS4Viz_0.2null, "./RDS/MABFanalyses/matrix-wise/rates4Viz/EUBF_TFPS4Viz_0.2null.RDS")
