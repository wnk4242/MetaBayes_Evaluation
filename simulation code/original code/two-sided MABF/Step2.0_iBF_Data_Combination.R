...
###################################
# Set the path to the directory containing RDS files
folder_path <- "./MABFoutcomes/500500/iBF" 
# List all RDS files in the directory
rds_files <- list.files(folder_path, pattern = "\\.RDS$", full.names = TRUE)
# Read in all RDS files into the workspace
for (file_path in rds_files) {
...
iBF_lists <- c(iBF_lists_nonelow_part1,iBF_lists_nonelow_part2,iBF_lists_nonelow_part3,
                  iBF_lists_nonelow_part4,iBF_lists_nonelow_part5,iBF_lists_nonelow_part6,
                  iBF_lists_nonelow_part7,iBF_lists_nonelow_part8,iBF_lists_nonelow_part9,
                  iBF_lists_medmed_part1,iBF_lists_medmed_part2,iBF_lists_medmed_part3,
                  iBF_lists_medmed_part4,iBF_lists_medmed_part5,iBF_lists_medmed_part6,
                  iBF_lists_medmed_part7,iBF_lists_medmed_part8,iBF_lists_medmed_part9,
                  iBF_lists_hihi_part1,iBF_lists_hihi_part2,iBF_lists_hihi_part3,
                  iBF_lists_hihi_part4,iBF_lists_hihi_part5,iBF_lists_hihi_part6,
                  iBF_lists_hihi_part7,iBF_lists_hihi_part8,iBF_lists_hihi_part9)
# Remove wont-be-used lists
remove(iBF_lists_nonelow_part1,iBF_lists_nonelow_part2,iBF_lists_nonelow_part3,
       iBF_lists_nonelow_part4,iBF_lists_nonelow_part5,iBF_lists_nonelow_part6,
       iBF_lists_nonelow_part7,iBF_lists_nonelow_part8,iBF_lists_nonelow_part9,
       iBF_lists_medmed_part1,iBF_lists_medmed_part2,iBF_lists_medmed_part3,
       iBF_lists_medmed_part4,iBF_lists_medmed_part5,iBF_lists_medmed_part6,
...
name_witht_0.2 <- !startsWith(names(iBF_lists), "0.2")
iBF_lists_0.5null <- iBF_lists[name_witht_0.2]
name_witht_0.5 <- !startsWith(names(iBF_lists), "0.5")
iBF_lists_0.2null <- iBF_lists[name_witht_0.5]
remove(iBF_lists)
...
# iBF_lists_0.2null_regrouped combines sublists with delta of 0 and 0.2
iBF_lists_0.2null_regrouped = list()
# Iterate through the list of sublists two at a time
for(i in seq(1, length(iBF_lists_0.2null), by = 2)) {
  # Combine vectors from the current pair of sublists
  combined = combine_vectors(iBF_lists_0.2null[[i]], iBF_lists_0.2null[[i+1]], chunk_size=num_deltai)
  # Add the combined result to the final groups list
  iBF_lists_0.2null_regrouped[[length(iBF_lists_0.2null_regrouped) + 1]] = combined
}
# Naming iBF sublists and matricies within
# Naming the main sublists
names(iBF_lists_0.2null_regrouped) <- IDs_MABFlists_002
# Naming contained matricies
iBF_lists_0.2null_regrouped <- lapply(iBF_lists_0.2null_regrouped, function(sublist) {
...
########################################################
# Initialize an empty list to store the final groups
# iBF_lists_0.5null_regrouped combines sublists with delta of 0 and 0.5
iBF_lists_0.5null_regrouped = list()
# Iterate through the list of sublists two at a time
for(i in seq(1, length(iBF_lists_0.5null), by = 2)) {
  # Combine vectors from the current pair of sublists
  combined = combine_vectors(iBF_lists_0.5null[[i]], iBF_lists_0.5null[[i+1]], chunk_size=num_deltai)
  # Add the combined result to the final groups list
  iBF_lists_0.5null_regrouped[[length(iBF_lists_0.5null_regrouped) + 1]] = combined
}
# Naming iBF sublists and matricies within
# Naming the main sublists
names(iBF_lists_0.5null_regrouped) <- IDs_MABFlists_005
# Naming contained matricies
iBF_lists_0.5null_regrouped <- lapply(iBF_lists_0.5null_regrouped, function(sublist) {
  names(sublist) <- IDs_MABFsubls
  return(sublist)
})

#saveRDS(iBF_lists_0.2null_regrouped, file = "./MABF4ROC/4TPFP/iBF_lists_0.2null_regrouped.RDS")
#saveRDS(iBF_lists_0.5null_regrouped, file = "./MABF4ROC/4TPFP/iBF_lists_0.5null_regrouped.RDS")
