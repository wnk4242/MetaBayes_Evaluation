# This R script asks the FEMABF method to synthesize the generated replication data
# that are not affected by p-hacking or publication bias.
# High-performance computers are required to run this R script.
#+++++++++++++++++++++++++++++++++++++++#
#Fixed-Effect Meta-Analysis Bayes Factor#
#+++++++++++++++++++++++++++++++++++++++#
######################################################
...
# Save results
saveRDS(FEMABF_lists_nonelow, sprintf("FEMABF_lists_nonelow_part%d.RDS", segment_index))
