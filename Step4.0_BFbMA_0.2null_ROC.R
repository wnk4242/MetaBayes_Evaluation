# This R script prepares data to create ROC curves for BFbMA outcomes.
######################################
...
BFbMA_lists_0.2null_regrouped <- readRDS("BFbMA_lists_0.2null_regrouped.RDS")
...
saveRDS(BFbMA_TPFP4ROC_0.2null, "BFbMA_0.2null.RDS")
